...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ѕυρρσят**: [Click](t.me/FLAME_MAINCHATS)\n"
        f"├• **¢нαииєℓ**: [Click](t.me/FLAME_MAINCHATS)\n"
        f"└• **яєρσ**: [Click](https://GitHub.com/MayankRai30/user)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/MayankRai30/user Fork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://t.me/FLAME_MAINCHATS")
